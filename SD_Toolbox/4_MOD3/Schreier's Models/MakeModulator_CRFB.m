%% --------------------------MODULATOR SYNTHESIS---------------------------
% 
% This code is the same as MakeModulator but with specifications adpated
% for the example reported in Chapter 4 of the book:
%
%   How To Design Sigma-Delta AD-Converters:
%       Beginners Practical Guide
%
%
