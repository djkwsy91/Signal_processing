...
%% STEP [1] - MODULATOR SPECIFICATIONS:
    ...
    OSR = 128;      % Oversampling ratio of the modulator 
    form = 'CRFF';  % Modulator architecture (accepted entries include: 
                    % 'CIFF','CIFB','CRFF' and 'CRFB') 
    nLev = 4;       % Number of levels in the quantizer 
    OBG = 1.51;     % Out of band gain of NTF - NaN for default by Schreier's
