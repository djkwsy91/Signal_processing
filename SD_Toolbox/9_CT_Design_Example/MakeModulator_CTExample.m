...
%% STEP [1] - MODULATOR SPECIFICATIONS:
    ...
    nLev = 7;           % Number of levels in the quantizer 
    OBG = 2.5;          % Out of band gain of NTF - NaN for default by Schreier's
    ...
    tdac = [0 0.5];	% DAC timing. [0 1] means zero-delay non-return-to-zero
